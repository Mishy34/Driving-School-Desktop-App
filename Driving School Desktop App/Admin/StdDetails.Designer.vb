...
Partial Class StdDetails
    ...
    Private Sub InitializeComponent()
        ...
        Heading.Size = New Size(304, 56)
        Heading.TabIndex = 8
        Heading.Text = "Student Details"
        ' 
        ' btnAddStudent
        ' 
        ...
        btnAddStudent.Size = New Size(217, 56)
